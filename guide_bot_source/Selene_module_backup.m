...
l{end+1}=[''];
l{end+1}=['COMPONENT sele_guide_11' num ' = guide_elliptical_89beta('];
...
l{end+1}=['    dimensionsAt = "entrance", m = selene_coating_x' num ',']; % TO DO, m different for x and y!
if gravity == 1
...
l{end+1}=[''];
l{end+1}=['COMPONENT sele_guide_12' num ' = guide_elliptical_89beta('];
l{end+1}=['    l = selene_length' num ', linxw = selene_distance' num ', linyh = selene_distance' num ','];
l{end+1}=['    loutxw = selene_distance' num ', loutyh = selene_distance' num ','];
l{end+1}=['    xwidth = 2*selene_entry_x' num ', yheight = 2*selene_entry_y' num ','];
l{end+1}=['    dimensionsAt = "entrance", m = selene_coating_x' num ',']; % TO DO, m different for x and y!
